...
class Node 
{
  ...
  public boolean isProcedure() { return false; }  //Built-ins and Closures
  ...
  public int getValue()        { System.err.print("Not Int "); return -1; }
  public boolean getBool()     { return true; }
  
 
  public Node eval(Node t, Environment env) 
  {  
      System.err.println("Can not call eval()"); 
      return null;
  }
  
  public Node apply(Node args)
  {
      System.err.println("Not BuiltIn or Closure");
      return null;
  }
}
